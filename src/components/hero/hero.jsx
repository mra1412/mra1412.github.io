...
import icon1 from '../../images/icon/golang.svg';
import icon2 from '../../images/icon/python.svg';
import icon3 from '../../images/icon/javascript.svg';
import icon4 from '../../images/icon/kubernetes.svg';
      ...
      <div className="static-hero-right">
        <div className="static-hero-img">
          <div className="static-hero-img-inner">
            ...
            <div className="project icon-3 floating-item">
              <img src={icon4} alt="" />
            </div>
