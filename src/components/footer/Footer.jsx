          ...
          <div className="row">
            <div className="col col-lg-4 col-md-6 col-12">
              <div className="widget about-widget">
                ...
                <p>
                  A Software Developer with a thirst for knowledge and who pays
                  attention to detail.
                </p>
                <div className="social-icons">
                  <ul>
                    <li>
                      <a
                        href="https://www.facebook.com/muhammadrehanabbasi"
                        target="_blank"
                        rel="noreferrer"
                      >
                    ...
                    <li>
                      <a
                        href="https://twitter.com/mrehanabbasi"
                        target="_blank"
                        rel="noreferrer"
                      >
                    ...
                    <li>
                      <a
                        href="https://linkedin.com/in/muhammadrehanabbasi"
                        target="_blank"
                        rel="noreferrer"
                      >
                    ...
                    <li>
                      <a
                        href="https://github.com/mrehanabbasi"
                        target="_blank"
                        rel="noreferrer"
                      >
        ...
        <div className="container">
          <div className="row">
            ...
            <p className="copyright">
              Copyright &copy; 2022 MRA. All rights reserved.
            </p>
          </div>
        </div>
      </div>
