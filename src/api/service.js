...
const Services = [
  ...
  //   },
  {
    ...
    description:
      'Designing of any kind of Full Stack Web applications using the MERN stack.',
    des2: 'Lacus, etiam sed est eu tempus need Temer diam congue laoret .',
    des3: 'One way to categorize the activities is in terms of the professional’s area of expertise such as competitive analysis, corporate strategy the activities',
  ...
  },
  {
    Id: '2',
    sImgS: adImgS1,
    sTitle: 'Go Development',
    description:
      'Designing and implementing Go backend APIs for any web-based service.',
    des2: 'Lacus, etiam sed est eu tempus need Temer diam congue laoret .',
    des3: 'One way to categorize the activities is in terms of the professional’s area of expertise such as competitive analysis, corporate strategy the activities',
  ...
  },
  {
    Id: '3',
    sImgS: swImgS1,
    sTitle: 'Python Development',
    description: 'Development of Python-based applications.',
    des2: 'Lacus, etiam sed est eu tempus need Temer diam congue laoret .',
    des3: 'One way to categorize the activities is in terms of the professional’s area of expertise such as competitive analysis, corporate strategy the activities',
